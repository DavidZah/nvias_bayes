...
img_one = cv2.imread('numbers\\0\\dan0.jpg', cv2.IMREAD_GRAYSCALE)
img_two = cv2.imread('numbers\\1\\dan1.jpg', cv2.IMREAD_GRAYSCALE)
...
img_two_test = cv2.imread('numbers\\0\\Jakub0.jpg', cv2.IMREAD_GRAYSCALE)
